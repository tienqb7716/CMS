...
( function( $) {
    $.wpMediaUploader = function( options ) {
        ...
        var settings = $.extend({
            ...
            target : '.buildr-uploader', // The class wrapping the textbox
            uploaderTitle : 'Select or upload image', // The title of the media upload popup
            uploaderButton : 'Set image', // the text of the button in the media upload popup
            multiple : false, // Allow the user to select multiple images
            buttonText : 'Upload image', // The text of the upload button
            buttonClass : '.buildr-upload', // the class of the upload button
...
//        $( settings.buttonClass ).css( settings.buttonStyle );
        ...
        $('body').on('click', settings.buttonClass, function(e) {
            ...
            .on('select', function() {
                ...
                selector.find( 'input' ).val(attachment.url).change();
                if( settings.modal ) {
